...
public interface GameState {
    ...
    /**
     * Gets an Entity whose type corresponds to the type given in input, taken from the current active entities.
     * @param type Type of the Entity.
     * @return An Optional of Entity if an Entity with the determined type was present, or an empty Optional otherwise.
     */
