...
public final class EnemyFactory {
    ...
    public EntityImpl createEnemyShooter(final GameState state, final Point2d position) {
        EntityImpl e = GameEngine.entityBuilder().type(Type.ENEMY_SHOOTER).position(position)
                ...
                .bbox(new CircleHitBox(new Circle2d(75))).zIndex(1).build();
    ...
    public EntityImpl createEnemySpinner(final GameState state, final Point2d position) {
        EntityImpl e = GameEngine.entityBuilder().type(Type.ENEMY_SPINNER).position(position)
                ...
                .bbox(new CircleHitBox(new Circle2d(75))).zIndex(10).build();
        state.getWorld().addGameObject(e.getGameObject());
        state.getView().addGraphicComponent(e.getView());
        return e;
    }
    ...
    public EntityImpl createEnemyDrunk(final GameState state, final Point2d position) {
        EntityImpl e = GameEngine.entityBuilder().type(Type.ENEMY_DRUNK).position(position)
                ...
                .bbox(new CircleHitBox(new Circle2d(55))).zIndex(0).build();
        state.getWorld().addGameObject(e.getGameObject());
        state.getView().addGraphicComponent(e.getView());
        return e;
    }
    ...
    public EntityImpl createEnemyLurker(final GameState state, final Point2d position) {
        EntityImpl e = GameEngine.entityBuilder().type(Type.ENEMY_LURKER).position(position)
                ...
                .bbox(new CircleHitBox(new Circle2d(55))).zIndex(1).build();
        state.getWorld().addGameObject(e.getGameObject());
        state.getView().addGraphicComponent(e.getView());
        return e;
    }
    ...
    public EntityImpl createEnemyDrunkSpinner(final GameState state, final Point2d position) {
        EntityImpl e = GameEngine.entityBuilder().type(Type.ENEMY_DRUNKSPINNER).position(position)
