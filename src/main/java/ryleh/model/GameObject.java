...
public interface GameObject {
    ...
    /**
     * This method is called once every update. This will update every component added to this object.
    ...
    /**
     * Gets component of a certain class that extends AbstractComponent, or an empty Optional if this object doesn't have
     * that component.
     * @param type Type of the component.
     * @return Optional of Component if contains that component, or an empty Optional otherwise.
     */
    ...
    HitBox getHitBox();
    /**
     * Sets object index on the z-axis(represents the loading order of textures).
     * @param zIndex Z coordinate.
     */
    void setzIndex(int zIndex);
    /**
     * Gets object's index on the z-axis.
     * @return Z coordinate.
     */
    int getzIndex();
}
