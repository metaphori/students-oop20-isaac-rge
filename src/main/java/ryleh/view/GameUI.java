...
public class GameUI {
    ...
    public GameUI() {
    	...
    	this.font = Font.loadFont(Ryleh.class.getResource("/assets/fonts/manaspc.ttf")
        		.toExternalForm(), FONT_SCALE * ViewHandlerImpl.SCALE_MODIFIER);
    	this.setLives();
    	this.setLevel();
    	this.setTutorial();
    	this.setItemPickUp();
    ...
    private void setLevel() {
        ...
        this.level.setX((ViewHandlerImpl.STANDARD_WIDTH / SCREEN_WIDTH_RATIO) * 2 + PIXEL_CORRECTION * ViewHandlerImpl.SCALE_MODIFIER);
	...
	private void setLives() {
        ...
        this.lives.setX((ViewHandlerImpl.STANDARD_WIDTH / SCREEN_WIDTH_RATIO) * 11 + PIXEL_CORRECTION * ViewHandlerImpl.SCALE_MODIFIER);
