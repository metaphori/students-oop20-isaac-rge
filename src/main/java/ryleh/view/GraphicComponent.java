...
public interface GraphicComponent {
    ...
    /**
     * The method that specifies the actions to be done when a GraphicComponent is added to the View. 
     ...
     * @param event The event that needs to be handled when the GraphicComponent is to be removed from the view.
     */
