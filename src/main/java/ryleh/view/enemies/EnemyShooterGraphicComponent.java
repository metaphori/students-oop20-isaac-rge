...
/**
 * A class that provides the GraphicComponent of the view related to the EnemyShooter Entity.
 */
public class EnemyShooterGraphicComponent implements GraphicComponent {
	...
	/**
	 * Creates a new Instance of EnemyShooterComponent with the given initial position.
