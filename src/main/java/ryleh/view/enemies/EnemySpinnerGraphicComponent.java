...
/**
 * A class that provides the GraphicComponent of the view related to the EnemySpinner Entity.
 */
public class EnemySpinnerGraphicComponent implements GraphicComponent {
	...
	/**
	 * Creates a new Instance of EnemySpinnerGraphicComponent with the given initial position.
